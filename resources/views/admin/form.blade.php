<div class="row">
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="number" name="performance" step="0.01" class="form-control @error('performance') is-invalid @enderror" 
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="number" name="consumption" step="0.01" class="form-control @error('consumption') is-invalid @enderror" 
    ...
    <div class="col-md-4 mb-3">
        ...
        <input type="number" name="number_of_seats" class="form-control @error('number_of_seats') is-invalid @enderror" 
    ...
    <div class="col-md-12 mb-3">
        ...
        <textarea name="description" rows="4" class="form-control @error('description') is-invalid @enderror" required>{{ old('description', $car->description ?? '') }}</textarea>
