<div class="row">
    ...
    <div class="col-md-4 mb-3">
        ...
        <select name="condition" class="form-select bg-dark text-white @error('condition') is-invalid @enderror" required>
            <option value="new" {{ old('condition', $car->condition ?? '') == 'new' ? 'selected' : '' }}>{{ __('New') }}</option>
            <option value="used" {{ old('condition', $car->condition ?? '') == 'used' ? 'selected' : '' }}>{{ __('Used') }}</option>
        </select>
    ...
    <div class="col-md-4 mb-3">
        <label class="form-label">{{ __('Performance (kW)') }}</label>
    ...
    <div class="col-md-4 mb-3">
        <label class="form-label">{{ __('Consumption (liters / 100km)') }}</label>
    ...
    <div class="col-md-4 mb-3">
        <label class="form-label">{{ __('Number of seats') }}</label>
    ...
    <div class="col-md-12 mb-3">
        <label class="form-label">{{ __('Additional Images (Max 10)') }}</label>
