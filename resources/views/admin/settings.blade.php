            ...
            <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="whatsapp"
                        class="form-control bg-dark text-white @error('whatsapp') is-invalid @enderror"
                ...
                <div class="mb-3">
                    ...
                    <input type="file" name="image"
                        class="form-control bg-dark text-white @error('image') is-invalid @enderror" accept="image/*">
                ...
                <div class="mb-3">
                    <label class="form-label">{{ __('Impressum') }}</label>
                    <textarea name="impressum"
                        class="form-control bg-dark text-white @error('impressum') is-invalid @enderror"
                        rows="10">{{ old('impressum', $settings->impressum) }}</textarea>
                    @error('impressum')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="mb-3">
                    <label class="form-label">{{ __('Datenschutzerklärung') }}</label>
                    <textarea name="datenschutz"
                        class="form-control bg-dark text-white @error('datenschutz') is-invalid @enderror"
                        rows="10">{{ old('datenschutz', $settings->datenschutz) }}</textarea>
                    @error('datenschutz')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
